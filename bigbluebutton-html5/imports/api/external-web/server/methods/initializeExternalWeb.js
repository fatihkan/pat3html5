...
export default function initializeExternalWeb() {
  ...
  if (!Meteor.StreamerCentral.instances[streamName]) {
    ...
    Logger.info(`Created External Web streamer for ${streamName}`);
  } else {
    Logger.debug(`External Web streamer is already created for ${streamName}`);
  }
}
